// Review-structure classifier for GitLab MRs.
// Entry: classifyMergeRequestReviewStrategy() — used by merge-request snapshot load.
// Consumers: walkthrough prompt guidance, walkthrough cache identity (reviewStructure),
// and the client commits/strategy summary. See PLAN.md §G1.
