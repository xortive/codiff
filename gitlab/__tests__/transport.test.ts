...
import { createFakeGitLabTransport } from '../src/transport.ts';
...
test('provides deterministic Web Crypto hashing for provider cache inputs', async () => {
  await expect(sha256('example')).resolves.toBe(
