...
export const walkthroughAuthoringVersion = 'walkthrough-v5-narrative-2';
...
export const buildReviewFocusPrompt = ({
  ...
  const fromLabel = review.comparison.before.head?.label.text ?? 'Unavailable';
  const toLabel = review.comparison.after.head?.label.text ?? 'Unavailable';
